-- Dynamic Database Schema Template
-- This schema uses placeholders for embedding dimensions that are replaced at runtime
-- Usage: sed 's/__EMBEDDING_DIMENSION__/1024/g' schema_dynamic.sql | psql -d your_database
...
CREATE OR REPLACE FUNCTION match_chunks(
    query_embedding vector(__EMBEDDING_DIMENSION__),
