...
async def send_email():
    ...
    if len(sys.argv) < 2 or sys.argv[1] in ['--help', '-h', 'help']:
        ...
        print("=" * 50)
        print("Usage: python3 send_email.py 'your email request'")
        print("\n📝 Examples:")
        print("  python3 send_email.py 'send email to john@company.com asking about the quarterly report'")
        print("  python3 send_email.py 'email sarah@gmail.com about the meeting tomorrow'")
        print("  python3 send_email.py 'write urgent email to support@service.com about system outage'")
        print("  python3 send_email.py 'send casual email to friend@gmail.com about weekend plans'")
        print("\n🎭 Supported Tones:")
